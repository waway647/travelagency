    ...
    <div class="booking-form-main-container">
        ...
        <div class="main-form-wrapper">
                    ...
                    <div class="modal" id="myModal">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form method="post" action="http://localhost/travelagency_ci/index.php/User_Controllers/User_tourpackage/part2_passenger_submit" enctype="multipart/form-data">
                                    <!-- Modal Header -->
                                                ...
                                                <div class="personal-information-column">
                                                    <div class="personal-information-row">
                                                        ...
                                                        <div class="personal-information-line">
                                                            <h6>First Name</h6>
                                                            <input type="text" name="passengerFname" id="first_name" placeholder="" required>
                                                        </div>
                                                        <div class="personal-information-line">
                                                            <h6>M.I.</h6>
                                                            <input type="text" name="passengerMinit" id="minit" placeholder="" required>
                                                        </div>
                                                        <div class="personal-information-line">
                                                            <h6>Last Name</h6>
                                                            <input type="text" name="passengerLname" id="last_name" placeholder="" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="personal-information-row">
                                                        <div class="personal-information-line">
                                                            <h6>Birthday</h6>
                                                            <input type="date" id="birthday" name="passengerBirthday" required>
                                                        </div>
                                                        <div class="personal-information-line">
                                                            <h6>Gender</h6>
                                                    ...
                                                    <div class="personal-information-row">
                                                        <div class="personal-information-line">
                                                            <h6>Nationality</h6>
                                                            <input type="text" name="passengerNationality" id="nationality" required>
                                                        </div>
                                                    </div>                         
                                                </div>
                                            </div>
            ...
            <div class="booking-contact-form-container">
                <form method="post" action="http://localhost/travelagency_ci/index.php/User_Controllers/User_tourpackage/part2_contact_submit">
                <div class="mytable">
                        ...
                        <h6>CONTACT INFORMATION</h6>
                            <div class="personal-information-row-contact">
                                <div class="personal-information-line">
                                    <h6>First Name</h6>
                                    <input type="text" name="contact_firstName" id="contact_firstName" required>
                                </div>
                                <div class="personal-information-line">
                                    <h6>M.I.</h6>
                                    <input type="text" name="contact_midInitial" id="contact_midInitial" required>
                                </div>
                                <div class="personal-information-line">
                                    <h6>Last Name</h6>
                                    <input type="text" name="contact_lastName" id="contact_lastName" required>
                                </div>
                                <div class="personal-information-line">
                                    <h6>Email</h6>
                                ...
                                <div class="personal-information-line">
                                    ...
                                    <input type="text" name="contact_contactNumber" id="contact_contactNumber" required>
                                </div>
                            </div>
                        </div>
                </div>
   ...
   $(document).ready(function(){
     ...
     function createTable(result,sno){
       ...
       for(index in result){
			...
			tr += "<td><a href='http://localhost/travelagency_ci/index.php/User_controllers/User_tourpackage/part2_passenger_edit/" + id + "'>Edit</a>";
			tr += "&nbsp<td><a href='http://localhost/travelagency_ci/index.php/User_controllers/User_tourpackage/part2_passenger_delete/" + id + "'>Delete</a></td>";
