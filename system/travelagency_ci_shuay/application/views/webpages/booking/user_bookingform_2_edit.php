    ...
    <div class="booking-form-main-container">
        ...
        <div class="mainform-container">
            <div class="maincontent-container">
                <div id="container">
                    <form method="post" action="<?php echo 'http://localhost/travelagency_ci/index.php/User_controllers/User_tourpackage/part2_passenger_update/' . $passenger->id; ?>">
                        ...
                        <div class="personal-information-line">
                            <h6>First Name</h6>
                            <input type="text" name="passengerFname" id="first_name" placeholder="" value="<?php echo $passenger->passengerFname; ?>" required>
                        </div>
                        
                        <div class="personal-information-line">
                            <h6>M.I.</h6>
                            <input type="text" name="passengerMinit" id="minit" placeholder="" value="<?php echo $passenger->passengerMinit; ?>" required>
                        </div>
                    
                        <div class="personal-information-line">
                            <h6>Last Name</h6>
                            <input type="text" name="passengerLname" id="last_name" placeholder="" value="<?php echo $passenger->passengerLname; ?>" required>
                        </div>
